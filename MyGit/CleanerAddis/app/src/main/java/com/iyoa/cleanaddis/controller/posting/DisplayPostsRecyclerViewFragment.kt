 ...
 * [DisplayPostsRecyclerViewFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [DisplayPostsRecyclerViewFragment.newInstance] factory method to
...
class DisplayPostsRecyclerViewFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DisplayPostsRecyclerViewFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DisplayPostsRecyclerViewFragment().apply {
